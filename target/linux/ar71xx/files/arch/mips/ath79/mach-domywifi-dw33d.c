...
#define DW33D_GPIO_LED_WLAN2G		13
...
#define DW33D_WAN_MAC_OFFSET		0
#define DW33D_LAN_MAC_OFFSET		6
#define DW33D_WMAC_MAC_OFFSET		12
#define DW33D_PCIE_MAC_OFFSET		18
...
static struct gpio_led dw33d_leds_gpio[] __initdata = {
	...
	{
		.name		= "dw33d:blue:wlan2g",
		.gpio		= DW33D_GPIO_LED_WLAN2G,
		.active_low	= 1,
	},
	{
...
static void __init dw33d_setup(void)
{
	...
	ath79_register_wmac(art + DW33D_WMAC_CALDATA_OFFSET, art + DW33D_WMAC_MAC_OFFSET);

	ath79_setup_qca955x_eth_cfg(QCA955X_ETH_CFG_RGMII_EN);

	ath79_setup_ar934x_eth_rx_delay(0, 0);
	...
	ath79_init_mac(ath79_eth0_data.mac_addr, art + DW33D_WAN_MAC_OFFSET, 0);
	...
	ath79_init_mac(ath79_eth1_data.mac_addr, art + DW33D_LAN_MAC_OFFSET, 0);
